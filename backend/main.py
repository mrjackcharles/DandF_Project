...
# Pre-existing rooms
room1 = Room(roomId="27f00b9e-b334-4f32-bd32-deb2ec8c30f6", 
...
room2 = Room(roomId="27f00b9e-b334-4f32-bd32-deb2ec8c30f7", 
...
room3 = Room(roomId="27f00b9e-b334-4f32-bd32-deb2ec8c30f8", 
...
room4 = Room(roomId="27f00b9e-b334-4f32-bd32-deb2ec8c30f9", 
...
def delete_room(room_id: str):
    for room in memory_db["rooms"]:
        if room.roomId == room_id:
            memory_db["rooms"].remove(room)  # Remove the room from the list
